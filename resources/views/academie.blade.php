                ...
                <div class="image-container">
                    <div id="carousel-2" class="carousel slide">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <img src="images/re2.jpg" class="d-block w-100" alt="...">
                            </div>
    ...
    <div class="row g-0 ">
        <div class="col-md-4 mb-md-2 ">
            <div class="card h-100 " >
                ...
                <div class="card-body">
                    <p class="card-title"> BERGER Thomas </p>
                    <p class="card-title">Né le 29/10/1968 en France </p>
                    <p class="card-title">Métier: Directeur général de l'académie
                        *Enseignement de l'université de Nice
                        Habite à Nantes</p>
        ...
        <div class="col-md-4">
            <div class="card ms-md-2 " >
                ...
                <div class="card-body">
                    ...
                    <p class="card-title">Né le 12/01/1974 au Burkina faso </p>
                    <p class="card-title">Métier: Comptabilité de gestion.</p>
                    <p class="card-title">tel: +22657386222</p>
                    <p class="card-text">
        ...
        <div class="col-md-4">
            <div class="card ms-md-2  " >
                ...
                <div class="card-body">
                    ...
                    <p class="card-title">Né le 19/04/1979 au Bénin </p>
                    <p class="card-title">Métier: Comptabilité de gestion.</p>
                    <p class="card-title">tel: +22955973628</p>
                    <p class="card-text">
                        En collaboration avec la fédération de française.</p>
