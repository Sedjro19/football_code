...
<nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
    <div class="container">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="images/logoo.jpeg" alt="alternative"></a>
        <a href="index.html" class="text-unlis"><span class="green fs-5">ACADEMY INTERNATIONAL  <span class="white">MICHEL HIDALGO</span></span></a>
