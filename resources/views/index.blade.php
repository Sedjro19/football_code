        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="image-container">
                    <img class="img-fluid rounded p-3" src="images/g1.jpeg" alt="alternative">
                </div>
            </div>
        </div>
    </div>
...
<div class="container my-5">
    ...
    <p class="text-muted text-center">Pour toute question, veuillez contacter notre service d'assistance au <strong>academy-international-michel-hidalgo@allagence.com</strong>.</p>
</div>
    ...
    <div class="row rows ">
        <div class="col-md-6 colmd6">
            <div class="embed-responsive embed-responsive-16by9">
                <video class="embed-responsive-item" src="images/aa.mp4" controls></video>
            </div>
        </div>
        <div class="col-md-6 colmd6 ">
            <div class="embed-responsive embed-responsive-16by9">
                <video class="embed-responsive-item" src="images/aaa.mp4" controls></video>
            </div>
        </div>
        <div class="col-md-6 colmd6">
            <div class="embed-responsive embed-responsive-16by9">
                <video class="embed-responsive-item" src="images/aaaa.mp4" controls></video>
            </div>
        </div>
        <div class="col-md-6 colmd6 ">
            <div class="embed-responsive embed-responsive-16by9">
                <video class="embed-responsive-item" src="images/aaaaa.mp4" controls></video>
            </div>
        </div>
    </div>
